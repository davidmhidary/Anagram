...
//  testing swiping
//
//  Created by SquareBits.
//  Copyright (c) 2015 Square Bits. All rights reserved.
//
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        [self setupView];
        information = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, self.frame.size.width, 40)];
        information.text = @"";
...
//        UIBezierPath *shadowPath3 = [UIBezierPath bezierPathWithRect:self.bounds];
