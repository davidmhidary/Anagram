...
- (UIBezierPath *)insideCirclePath
{
    ...
    UIBezierPath *path = [UIBezierPath bezierPathWithArcCenter:arcCenter radius:CGRectGetWidth(self.bounds) / 2.0f startAngle:(3.0f * M_PI_2) endAngle:(3.0f * M_PI_2) + (2.0f * M_PI) clockwise:YES];
    return path;
}
...
- (UIBezierPath *)outsideCirclePath
{
    ...
    UIBezierPath *path = [UIBezierPath bezierPathWithArcCenter:arcCenter radius:radius startAngle:(3.0f * M_PI_2) endAngle:(3.0f * M_PI_2) + (2.0f * M_PI) clockwise:YES];
    return path;
}
...
//        [_valueTextLabel setTranslatesAutoresizingMaskIntoConstraints:NO];
        ...
        _valueTextLabel.frame = CGRectMake(-5, 2, self.frame.size.width + 10, self.frame.size.height - 7);
        _valueTextLabel.center = CGPointMake(self.frame.size.width / 2.0 + 0.3, self.frame.size.height / 2.0 + 1.0);
        _valueTextLabel.backgroundColor = [UIColor clearColor];
    }
